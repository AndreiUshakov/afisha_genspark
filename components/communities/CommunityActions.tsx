...
export default function CommunityActions({ 
  ...
  const handleManageClick = () => {
    router.push(`/dashboard/community/${communitySlug}/settings`);
  };
  ...
  return (
    <div className="flex flex-wrap gap-3">
      {/* Кнопка действия - зависит от статуса пользователя */}
      {initialIsOwner ? (
        // Владелец - кнопка "Управление"
        <button
          onClick={handleManageClick}
          className="flex-1 min-w-[200px] px-6 py-3 font-semibold rounded-lg transition-colors bg-purple-600 text-white hover:bg-purple-700"
        >
          Управление
        </button>
      ) : (
        // Не владелец - кнопка "Вступить" / "Покинуть"
        <button
      ...
      <div className="relative">
        <button
          ...
          className="p-3 rounded-lg border border-gray-300 bg-white dark:bg-gray-800 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
            ...
            <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50">
              <div className="py-2">
                <button
                  ...
                  className="w-full px-4 py-2 text-left hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center gap-3 dark:text-gray-200"
                >
