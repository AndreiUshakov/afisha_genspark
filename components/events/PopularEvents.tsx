...
export default function PopularEvents() {
  // Берем первые 3 самых популярных события (с is_featured = true или с наибольшим количеством просмотров)
  const popularEvents = mockEvents
    .filter(event => event.is_published)
    .sort((a, b) => {
      // Сначала is_featured, потом по просмотрам
          ...
          return (
            ...
            >
              ...
              <div className="p-4 md:p-6">
                ...
                <h3 className="mt-2 text-xl font-semibold text-gray-800 group-hover:text-blue-600 dark:text-neutral-300 dark:group-hover:text-white line-clamp-2">
                  {event.title}
                </h3>
