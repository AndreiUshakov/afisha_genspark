...
Проект настроен для автоматического деплоя на [Amvera.io](https://amvera.io) с CI/CD.

### Быстрый старт:

1. **Подключите репозиторий** в панели Amvera
2. **Выберите ветку** `main`
3. **Запустите деплой** - Amvera автоматически обнаружит `amvera.yml`

Конфигурация уже готова в файле `amvera.yml`:
- ✅ Node.js 20 окружение
- ✅ Автоматическая установка зависимостей
- ✅ Production сборка Next.js
- ✅ Кэширование `.next` директории
