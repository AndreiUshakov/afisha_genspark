          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <p className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                Редактирование контента страницы заблокировано до завершения модерации. Вы можете только просматривать настройки и работать с медиагалереей.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <p className="mt-2 text-sm text-blue-700 dark:text-blue-300">
                Сообщество опубликовано. Любые изменения контента потребуют повторной модерации перед публикацией.
              </p>
            </div>
          </div>
        </div>
